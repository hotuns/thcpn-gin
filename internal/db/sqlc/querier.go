...
type Querier interface {
	...
	ListDeviceSourceRefsByWorkspace(ctx context.Context, workspaceID uuid.UUID) ([]DeviceSourceRef, error)
	...
	ListSystemDataSources(ctx context.Context) ([]DataSource, error)
	...
	UnbindDevice(ctx context.Context, id uuid.UUID) (Device, error)

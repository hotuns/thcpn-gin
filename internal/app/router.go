...
func registerAPIV1(router *gin.Engine, deps Dependencies, cfg config.Config) error {
	...
	admin.POST("/auth/password/change", adminAuthHandler.ChangePassword)
	...
	admin.DELETE("/metadata/device-taxonomy/:term_id", deviceClassificationHandler.AdminDeleteTerm)
	...
	admin.POST("/devices/:device_id/config/resync", dataSourceHandler.AdminReconcileDeviceConfig)
	admin.GET("/devices/:device_id/source-config/:config_kind", dataSourceHandler.AdminDeviceSourceConfig)
	admin.POST("/devices/:device_id/source-config/:config_kind", dataSourceHandler.AdminDeviceSourceConfig)
	admin.POST("/data-sources/:data_source_id/sync", dataSourceHandler.AdminStartSourceSync)
	admin.GET("/source-operations/:operation_id", dataSourceHandler.AdminSourceOperation)
	admin.GET("/data-sources/:data_source_id/operations", dataSourceHandler.AdminSourceOperations)
	...
	admin.GET("/data-streams", dataStreamHandler.AdminList)
	admin.GET("/data-streams/:data_stream_id/telemetry", telemetryHandler.AdminQueryDataStream)
	admin.GET("/devices/:device_id/telemetry", telemetryHandler.AdminQueryDevice)
	admin.GET("/devices/:device_id/media/images", mediaHandler.AdminListDeviceImages)
	...
	admin.GET("/devices/:device_id/lorawan-v2/logs", dataSourceHandler.AdminListDeviceLoRaWANV2GatewayLogs)
	admin.GET("/devices/:device_id/lorawan-v2/context", dataSourceHandler.AdminGetDeviceLoRaWANV2Context)
	...
	admin.POST("/data-sources/:data_source_id/devices", dataSourceHandler.AdminCreateSourceDevice)
	admin.POST("/data-sources/:data_source_id/devices/sync", dataSourceHandler.AdminRetrySourceDeviceSync)
	...
	admin.GET("/data-sources/:data_source_id/lorawan-v2/health", dataSourceHandler.AdminLoRaWANV2Health)
	...
	admin.DELETE("/data-sources/:data_source_id/lorawan-v2/firmwares/:firmware_id", dataSourceHandler.AdminDeleteLoRaWANV2Firmware)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/configs", dataSourceHandler.AdminListLoRaWANV2GatewayConfigs)
	admin.POST("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/configs", dataSourceHandler.AdminCreateLoRaWANV2GatewayConfig)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/configs/:config_id", dataSourceHandler.AdminGetLoRaWANV2GatewayConfig)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/sensor-configs", dataSourceHandler.AdminListLoRaWANV2NodeSensorConfigs)
	admin.POST("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/sensor-configs", dataSourceHandler.AdminCreateLoRaWANV2NodeSensorConfig)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/sensor-configs/latest", dataSourceHandler.AdminGetLatestLoRaWANV2NodeSensorConfig)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/sensor-configs/:config_id", dataSourceHandler.AdminGetLoRaWANV2NodeSensorConfig)
	admin.POST("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/time-config", dataSourceHandler.AdminCreateLoRaWANV2NodeTimeConfig)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/logs", dataSourceHandler.AdminListLoRaWANV2GatewayLogs)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/nodes/:node_index/data", dataSourceHandler.AdminListLoRaWANV2NodeData)
	admin.GET("/data-sources/:data_source_id/lorawan-v2/gateways/:gateway_sn/infos", dataSourceHandler.AdminListLoRaWANV2GatewayInfos)
	...
	authed.POST("/devices/:device_id/config/resync", dataSourceHandler.ReconcileDeviceConfig)

  ...
  "zh-CN": {
    ...
    admin: {
      ...
      firmware: {
        ...
        search: "搜索设备名称或 SN", statusFilter: "发布状态", allStatuses: "全部状态", completed: "已完成", partial: "部分完成", failed: "失败", publishing: "发布中",
        ...
        summary: "将 {{filename}} 的 {{version}} 版本发布到 {{count}} 台设备。", validation: "请提供有效文件、版本号、32 位 MD5 Base16 并至少选择一台设备。", mixedSources: "一次发布只能选择属于同一个数据源的设备。", loraVersionValidation: "LoRaWAN V2 版本必须是四段 0–255 的数字，例如 1.2.3.4。", buildIdValidation: "Carbon Build ID 由管理员填写，且必须是正整数。", uploading: "正在上传并发布…", publish: "上传并发布", unassigned: "未分配工作区",
  ...
  "en-US": {
    ...
    admin: {
      ...
      firmware: {
        ...
        search: "Search device name or SN", statusFilter: "Release status", allStatuses: "All statuses", completed: "Completed", partial: "Partially completed", failed: "Failed", publishing: "Publishing",

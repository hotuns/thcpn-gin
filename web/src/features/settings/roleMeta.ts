import type { AccessGrantRoleCode, AccessGrantScopeType, InternalMemberRoleCode, MemberScopeType } from "../../api";
...
export interface RoleMeta {
  ...
  summary: string;
  risk?: string;
  allowedScopes?: MemberScopeType[];
}

export const internalRoleMeta: Record<InternalMemberRoleCode, RoleMeta & { allowedScopes: MemberScopeType[] }> = {
  owner: {
    code: "owner",
    label: "Owner",
